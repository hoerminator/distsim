...
public final class BullyElectionController implements AlgorithmController {
    @Override
    public AlgorithmId id() {
        return AlgorithmIds.BULLY_ELECTION;
    }

    @Override
    public String displayName() {
        return "Bully election";
    }
    ...
    public void start(MutableSimulationState state, long scheduledTime, NodeId initiator, long round) {
        ProtocolContext.schedule(
                ...
                context -> BullyElectionProtocol.INSTANCE.startAlgorithm(context, initiator, round)
        );
    }
}
